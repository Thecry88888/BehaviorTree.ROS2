        ...
        while (rclcpp::ok()) {
            ...
            try {
                t = tf_buffer_->lookupTransform(
                    "base_link", "link_6", tf2::TimePointZero); // newest
                // manual test command:
                // ros2 run tf2_ros static_transform_publisher --x 100 --y 50 --z 200 --yaw 0 --pitch 0 --roll 0 --frame-id base_link --child-frame-id link_6
